    ...
    <div id="main-chat-wrapper">
        <div class="chat-window-wrapper fadeIn" id="chat-users">
            ...
            <div class="side-widget fadeIn">
                ...
                <div class="side-widget-content">
                    <!-- BEGIN SAMPLE CHAT -->
                    <div class="user-details-wrapper active" data-chat-status="online" data-chat-user-pic="assets/profiles/avatar.jpg"
                         data-chat-user-pic-retina="assets/profiles/d2x.jpg" data-user-name="Jane Smith">
                        <!-- BEGIN PROFILE PIC -->
                        <div class="user-profile">
                            <img src="assets/profiles/avatar.jpg" alt="" data-src="assets/profiles/avatar.jpg"
                                 data-src-retina="assets/profiles/d2x.jpg" width="35" height="35">
                        </div>
                        <!-- END PROFILE PIC -->
                        <!-- BEGIN MESSAGE -->
            ...
            <div class="side-widget">
                ...
                <div class="side-widget-content" id="friends-list">
                    <!-- BEGIN SAMPLE CHAT -->
                    <div class="user-details-wrapper" data-chat-status="online" data-chat-user-pic="assets/profiles/avatar.jpg"
                         data-chat-user-pic-retina="assets/profiles/d2x.jpg" data-user-name="Jane Smith">
                        <!-- BEGIN PROFILE PIC -->
                        <div class="user-profile">
                            <img src="assets/profiles/avatar.jpg" alt="" data-src="assets/profiles/avatar.jpg"
        ...
        <div class="chat-window-wrapper fadeIn" id="messages-wrapper" style="display:none">
            ...
            <div class="chat-messages">
                ...
                <div class="user-details-wrapper">
                    ...
                    <div class="user-profile">
                        <img src="assets/profiles/avatar.jpg" alt="" data-src="assets/profiles/avatar.jpg" data-src-retina="assets/profiles/d2x.jpg"
                             width="35" height="35">
                    </div>
